namespace Ex_05
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Decrescente ou Crescente? (D / C): ");
            char ordem = Convert.ToChar(Console.ReadLine().ToUpper());
            ...
            {
                Console.WriteLine("Nenhuma ordem correta");
            }
        }
    }
}